...
item_block("4. Estructura","4.1.1","Columnas concreto 3000 psi","M3",
    ...
    [("Tipo 1: 0.40×0.40, h=4.70, 4 und","Ejes 1A, 1B, 3'B, 4A (despiece del plano)."),
     ("Tipo 2: 0.50×0.50, h=4.90, 4 und","Ejes 2A, 2B, 3A, 3B (despiece del plano)."),
     ("Total 8 columnas","Contadas y verificadas en el despiece (NO son 10).")],
    "V = (0.40×0.40×4.70×4) + (0.50×0.50×4.90×4) = 3.01 + 4.90","7.91 m³",
    obs="CORREGIDO: antes se había puesto 10 columnas iguales de 0.40×0.40. El plano muestra 8 columnas en dos tipos.",
